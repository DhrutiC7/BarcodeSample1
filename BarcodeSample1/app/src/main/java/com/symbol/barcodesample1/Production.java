...
public class Production extends Activity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
                ...
                (Request.Method.POST, warehouseOpUrl, parameters, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            updateStatus(response.get("msg").toString(),response.get("msg_color").toString());
                        }catch(Exception ex){
...
//                updateStatus(statusString,okColor);
    ...
    private void enumerateScannerDevices() {
        if (barcodeManager != null) {
            ...
            ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(Production.this, android.R.layout.simple_spinner_item, friendlyNameList);
