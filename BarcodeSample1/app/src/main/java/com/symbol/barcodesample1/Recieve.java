...
public class Recieve extends Activity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
...
// Add the request to the RequestQueue.
    ...
    private void enumerateScannerDevices() {
        if (barcodeManager != null) {
            ...
            ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(Recieve.this, android.R.layout.simple_spinner_item, friendlyNameList);
